...
Q_CONSTINIT static const uint qt_meta_data_CLASSExtProcessENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      10,    0,   51,    2, 0x09,    8 /* Protected */,
      11,    0,   52,    2, 0x09,    9 /* Protected */,
      12,    2,   53,    2, 0x09,   10 /* Protected */,
...
void ExtProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->report_finished((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QProcess::ExitStatus>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ExtProcess::report_message; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
