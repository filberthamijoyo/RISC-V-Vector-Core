...
#include "../../../../../src/machine/memory/backend/aclintsswi.h"
...
struct qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS = QtMocHelpers::stringData(
    "machine::aclint::AclintSswi",
    "write_notification",
    "",
    "Offset",
    "address",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       7,    2,   37,    2, 0x106,    4 /* Public | MethodIsConst  */,
       8,    2,   42,    2, 0x106,    7 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject machine::aclint::AclintSswi::staticMetaObject = { {
    QMetaObject::SuperData::link<BackendMemory::staticMetaObject>(),
    qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AclintSswi, std::true_type>,
...
void machine::aclint::AclintSswi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signal_interrupt((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AclintSswi::write_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &AclintSswi::read_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &AclintSswi::signal_interrupt; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *machine::aclint::AclintSswi::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintSswiENDCLASS.stringdata0))
