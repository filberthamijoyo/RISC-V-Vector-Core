...
"           :/icons/gui.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        MainWindow->setWindowIcon(icon);
        MainWindow->setDockNestingEnabled(false);
        MainWindow->setUnifiedTitleAndToolBarOnMac(true);
        actionNewMachine = new QAction(MainWindow);
        actionNewMachine->setObjectName("actionNewMachine");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/document-import.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/new.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionNew->setIcon(icon2);
        actionOpen = new QAction(MainWindow);
        actionOpen->setObjectName("actionOpen");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/open.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOpen->setIcon(icon3);
        actionSave = new QAction(MainWindow);
        actionSave->setObjectName("actionSave");
        actionSave->setEnabled(false);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/save.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/closetab.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionClose->setIcon(icon5);
        actionCompileSource = new QAction(MainWindow);
        actionCompileSource->setObjectName("actionCompileSource");
        actionCompileSource->setEnabled(false);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/compfile-256.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionCompileSource->setIcon(icon6);
        actionBuildExe = new QAction(MainWindow);
        actionBuildExe->setObjectName("actionBuildExe");
        actionBuildExe->setEnabled(true);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/build-256.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionBuildExe->setIcon(icon7);
        actionExit = new QAction(MainWindow);
        actionExit->setObjectName("actionExit");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/application-exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionExit->setIcon(icon8);
        actionRun = new QAction(MainWindow);
        actionRun->setObjectName("actionRun");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/play.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRun->setIcon(icon9);
        actionStep = new QAction(MainWindow);
        actionStep->setObjectName("actionStep");
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/next.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionStep->setIcon(icon10);
        actionPause = new QAction(MainWindow);
        actionPause->setObjectName("actionPause");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/pause.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPause->setIcon(icon11);
        ips1 = new QAction(MainWindow);
        ips1->setObjectName("ips1");
        ips1->setCheckable(true);
        ips5 = new QAction(MainWindow);
        ips5->setObjectName("ips5");
        ips5->setCheckable(true);
        ips10 = new QAction(MainWindow);
        ips10->setObjectName("ips10");
        ips10->setCheckable(true);
        ips25 = new QAction(MainWindow);
        ips25->setObjectName("ips25");
        ips25->setCheckable(true);
        ipsUnlimited = new QAction(MainWindow);
        ipsUnlimited->setObjectName("ipsUnlimited");
        ipsUnlimited->setCheckable(true);
        actionMemory = new QAction(MainWindow);
        actionMemory->setObjectName("actionMemory");
        actionProgram_memory = new QAction(MainWindow);
        actionProgram_memory->setObjectName("actionProgram_memory");
        actionRegisters = new QAction(MainWindow);
        actionRegisters->setObjectName("actionRegisters");
        actionCsrShow = new QAction(MainWindow);
        actionCsrShow->setObjectName("actionCsrShow");
        actionReload = new QAction(MainWindow);
        actionReload->setObjectName("actionReload");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/reload.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionReload->setIcon(icon12);
        actionPrint = new QAction(MainWindow);
        actionPrint->setObjectName("actionPrint");
        actionProgram_Cache = new QAction(MainWindow);
        actionProgram_Cache->setObjectName("actionProgram_Cache");
        actionData_Cache = new QAction(MainWindow);
        actionData_Cache->setObjectName("actionData_Cache");
        actionL2_Cache = new QAction(MainWindow);
        actionL2_Cache->setObjectName("actionL2_Cache");
        actionResetWindows = new QAction(MainWindow);
        actionResetWindows->setObjectName("actionResetWindows");
        ips2 = new QAction(MainWindow);
        ips2->setObjectName("ips2");
        ips2->setCheckable(true);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName("actionAbout");
        ipsMax = new QAction(MainWindow);
        ipsMax->setObjectName("ipsMax");
        ipsMax->setCheckable(true);
        actionAboutQt = new QAction(MainWindow);
        actionAboutQt->setObjectName("actionAboutQt");
        actionPeripherals = new QAction(MainWindow);
        actionPeripherals->setObjectName("actionPeripherals");
        actionTerminal = new QAction(MainWindow);
        actionTerminal->setObjectName("actionTerminal");
        actionLcdDisplay = new QAction(MainWindow);
        actionLcdDisplay->setObjectName("actionLcdDisplay");
        actionShow_Symbol = new QAction(MainWindow);
        actionShow_Symbol->setObjectName("actionShow_Symbol");
        actionCore_View_show = new QAction(MainWindow);
        actionCore_View_show->setObjectName("actionCore_View_show");
        ...
        actionMnemonicRegisters->setObjectName("actionMnemonicRegisters");
        ...
        actionEditorShowLineNumbers->setObjectName("actionEditorShowLineNumbers");
        ...
        actionBranch_Predictor_History_table->setObjectName("actionBranch_Predictor_History_table");
        actionBranch_Predictor_Target_table = new QAction(MainWindow);
        actionBranch_Predictor_Target_table->setObjectName("actionBranch_Predictor_Target_table");
        actionBranch_Predictor_Info = new QAction(MainWindow);
        actionBranch_Predictor_Info->setObjectName("actionBranch_Predictor_Info");
        ...
        menuMachine->setObjectName("menuMachine");
