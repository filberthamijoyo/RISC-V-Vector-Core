...
public:
    ...
    void setupUi(QWidget *PeripheralsView)
    {
        if (PeripheralsView->objectName().isEmpty())
            PeripheralsView->setObjectName("PeripheralsView");
        ...
        labelRgb1->setObjectName("labelRgb1");
        ...
        lineEditRgb1->setObjectName("lineEditRgb1");
        ...
        labelRgb2->setObjectName("labelRgb2");
        ...
        lineEditRgb2->setObjectName("lineEditRgb2");
