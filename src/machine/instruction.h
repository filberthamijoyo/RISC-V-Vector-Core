...
enum InstructionFlags : unsigned long {
    ...
    // RVV (RISC-V Vector Extensions)
    IMF_VSETVL = 1L << 25,  /**< Instruction is VSETVL */
    IMF_VADDVV = 1L << 26,  /**< Vector Add (VV format) */
    IMF_VADDVX = 1L << 27,  /**< Vector Add (VX format) */
    IMF_VADDVI = 1L << 28,  /**< Vector Add (VI format) */
    IMF_VMUL   = 1L << 29,  /**< Vector Multiply (VV format) */
    IMF_LOAD   = 1L << 30,  /**< Vector Load */
    IMF_STORE  = 1L << 31,  /**< Vector Store */
    IMF_MM = 1L << 32,
