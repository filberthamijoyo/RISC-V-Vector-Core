...
struct qt_meta_stringdata_CLASSmachineSCOPELcdDisplayENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmachineSCOPELcdDisplayENDCLASS = QtMocHelpers::stringData(
    "machine::LcdDisplay",
    "write_notification",
    "",
    "Offset",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmachineSCOPELcdDisplayENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject machine::LcdDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<BackendMemory::staticMetaObject>(),
    qt_meta_stringdata_CLASSmachineSCOPELcdDisplayENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmachineSCOPELcdDisplayENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmachineSCOPELcdDisplayENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LcdDisplay, std::true_type>,
...
void machine::LcdDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->pixel_update((*reinterpret_cast< std::add_pointer_t<size_t>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<size_t>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<uint>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<uint>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<uint>>(_a[5]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LcdDisplay::write_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LcdDisplay::*)(Offset , uint32_t ) const;
            if (_t _q_method = &LcdDisplay::read_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &LcdDisplay::pixel_update; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *machine::LcdDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmachineSCOPELcdDisplayENDCLASS.stringdata0))
