...
// Full, uncompressed, instructions top-level map
static const struct InstructionMap VSET_map[] = {
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"vsetvl", IT_R, NOALU, NOMEM, nullptr, {"d", "s", "t"}, 0x00006007, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_REGWRITE | IMF_ALU_REQ_RS | IMF_ALU_REQ_RT | IMF_VSETVL }, nullptr},
    IM_UNKNOWN,
};

static const struct InstructionMap VADD_map[] = {
    {"vadd.vv", IT_R, { .alu_op = AluOp::ADD }, NOMEM, nullptr, {"d", "s", "t"}, 0x00000027, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_ALU_REQ_RS | IMF_ALU_REQ_RT | IMF_REGWRITE | IMF_ALU_MOD | IMF_VADDVV }, nullptr},
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"vadd.vx", IT_R, { .alu_op = AluOp::ADD }, NOMEM, nullptr, {"d", "s", "t"}, 0x00004027, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_ALU_REQ_RS | IMF_REGWRITE | IMF_ALU_REQ_RT | IMF_ALU_MOD | IMF_VADDVX }, nullptr},
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
};

static const struct InstructionMap VADDI_map[] = {
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"vadd.vi", IT_I, { .alu_op = AluOp::ADD }, NOMEM, nullptr, {"d", "s", "j"}, 0x0000005b, 0x0001ffff, { .flags = IMF_SUPPORTED | IMF_ALUSRC | IMF_ALU_REQ_RT | IMF_ALU_REQ_RS | IMF_REGWRITE | IMF_ALU_MOD | IMF_VADDVI }, nullptr},
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
...
static const struct InstructionMap VMUL_map[] = {
    {"vmul.vv", IT_R, NOALU, NOMEM, nullptr, {"d", "s", "t"}, 0x0000002b, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_ALU_REQ_RS | IMF_ALU_REQ_RT | IMF_REGWRITE | IMF_ALU_MOD | IMF_VMUL }, nullptr},
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
...
static const struct InstructionMap VLOAD_map[] = {
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"vlw.v", IT_I, NOALU, AC_I32, nullptr, {"d", "o(s)"}, 0x0000600b, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_MEM | IMF_ALUSRC | IMF_ALU_REQ_RS | IMF_REGWRITE | IMF_LOAD }, nullptr},
    IM_UNKNOWN,
};

static const struct InstructionMap VSTORE_map[] = {
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"vsw.v", IT_S, NOALU, AC_I32, nullptr, {"t", "q(s)"}, 0x0000601f, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_MEM | IMF_ALUSRC | IMF_ALU_REQ_RS | IMF_STORE }, nullptr},
    IM_UNKNOWN,
};

static const struct InstructionMap MM_map[] = {
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    IM_UNKNOWN,
    {"mm", IT_S, NOALU, AC_I32, nullptr, {"d", "s", "t"}, 0x0000603f, 0x0000707f, { .flags = IMF_SUPPORTED | IMF_MEM | IMF_ALUSRC | IMF_ALU_REQ_RS | IMF_ALU_REQ_RT | IMF_REGWRITE | IMF_MM}, nullptr},
    IM_UNKNOWN,
};
...
static const struct InstructionMap I_inst_map[] = {
    ...
    {"vsetvl", IT_R, NOALU, NOMEM, VSET_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, // VSET
    {"vlw.v", IT_I, NOALU, AC_I32, VLOAD_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, // VLOAD
    ...
    {"op-imm-32", IT_I, NOALU, NOMEM, OP_IMM_32_map, {}, 0x1b, 0x7f, { .subfield = {3, 12} }, nullptr}, // OP-IMM-32
    {"vsw.v", IT_S, NOALU, AC_I32, VSTORE_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, // VSTORE
    {"store", IT_I, NOALU, NOMEM, STORE_map, {}, 0x23, 0x7f, { .subfield = {3, 12} }, nullptr}, // STORE
    {"vadd.vv", IT_R, { .alu_op=AluOp::ADD }, NOMEM, VADD_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, // VADD
    {"vmul.vv", IT_R, NOALU, NOMEM, VMUL_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, // VMUL
    {"amo", IT_R, NOALU, NOMEM, AMO_map, {}, 0x2f, 0x7f, { .subfield = {3, 12} }, nullptr}, // Atomic Memory Ops
    ...
    {"mm", IT_R, { .alu_op=AluOp::ADD }, NOMEM, MM_map, {}, 0x57, 0x7f, { .subfield = {3, 12} }, nullptr}, //
    IM_UNKNOWN, // MADD
    IM_UNKNOWN, // MSUB
    IM_UNKNOWN, // NMSUB
    IM_UNKNOWN, // NMADD
    ...
    {"jalr", IT_I, { .alu_op=AluOp::ADD }, NOMEM, nullptr, {"d", "o(s)"}, 0x67, 0x7f, { .flags = IMF_SUPPORTED | IMF_REGWRITE | IMF_BRANCH_JALR | IMF_ALUSRC | IMF_ALU_REQ_RS }, inst_aliases_jalr}, // JALR
    IM_UNKNOWN, // reserved
    {"jal", IT_J, { .alu_op=AluOp::ADD }, NOMEM, nullptr, {"d", "a"}, 0x6f, 0x7f, { .flags = IMF_SUPPORTED | IMF_REGWRITE | IMF_JUMP | IMF_PC_TO_ALU | IMF_ALUSRC }, inst_aliases_jal}, // JAL
...
static int parse_reg_from_string(const QString &str, uint *chars_taken = nullptr) {
    ...
    if (str.at(0) == 'x') {
        ...
        if (res >= 0 && res < 32) {  // Ensure valid vector register number
            *chars_taken = ctk;
            return res;  // Vector registers v0 to v31 map directly to indices 0-31
        } else {
            return -1;  // Invalid vector register number
        }
    } else {
