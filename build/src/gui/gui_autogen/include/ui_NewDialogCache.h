...
public:
    ...
    void setupUi(QWidget *NewDialogCache)
    {
        if (NewDialogCache->objectName().isEmpty())
            NewDialogCache->setObjectName("NewDialogCache");
        ...
        number_of_sets->setObjectName("number_of_sets");
        ...
        block_size->setObjectName("block_size");
        ...
        degree_of_associativity->setObjectName("degree_of_associativity");
        ...
        writeback_policy->addItem(QString());
        writeback_policy->addItem(QString());
        writeback_policy->setObjectName("writeback_policy");
