...
struct qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS = QtMocHelpers::stringData(
    "machine::aclint::AclintMtimer",
    "write_notification",
    "",
    "Offset",
    "address",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject machine::aclint::AclintMtimer::staticMetaObject = { {
    QMetaObject::SuperData::link<BackendMemory::staticMetaObject>(),
    qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AclintMtimer, std::true_type>,
...
void machine::aclint::AclintMtimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AclintMtimer::write_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &AclintMtimer::read_notification; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &AclintMtimer::signal_interrupt; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *machine::aclint::AclintMtimer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmachineSCOPEaclintSCOPEAclintMtimerENDCLASS.stringdata0))
