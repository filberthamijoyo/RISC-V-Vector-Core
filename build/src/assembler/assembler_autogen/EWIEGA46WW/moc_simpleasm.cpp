...
struct qt_meta_stringdata_CLASSSimpleAsmENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSimpleAsmENDCLASS = QtMocHelpers::stringData(
    "SimpleAsm",
    "report_message",
    "",
    "messagetype::Type",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSimpleAsmENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SimpleAsm::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSSimpleAsmENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSimpleAsmENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSimpleAsmENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SimpleAsm, std::true_type>,
...
void SimpleAsm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SimpleAsm::report_message; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SimpleAsm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSimpleAsmENDCLASS.stringdata0))
