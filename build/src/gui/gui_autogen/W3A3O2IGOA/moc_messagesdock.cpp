...
struct qt_meta_stringdata_CLASSMessagesDockENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMessagesDockENDCLASS = QtMocHelpers::stringData(
    "MessagesDock",
    "report_message",
    "",
    "messagetype::Type",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMessagesDockENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      10,    0,   57,    2, 0x06,    8 /* Public */,
      11,    6,   58,    2, 0x06,    9 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      12,    6,   71,    2, 0x0a,   16 /* Public */,
      13,    0,   84,    2, 0x0a,   23 /* Public */,
...
Q_CONSTINIT const QMetaObject MessagesDock::staticMetaObject = { {
    QMetaObject::SuperData::link<QDockWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSMessagesDockENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMessagesDockENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMessagesDockENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MessagesDock, std::true_type>,
...
void MessagesDock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MessagesDock::report_message; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &MessagesDock::pass_clear_messages; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MessagesDock::*)(messagetype::Type , QString , int , int , QString , QString );
            if (_t _q_method = &MessagesDock::message_selected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *MessagesDock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMessagesDockENDCLASS.stringdata0))
