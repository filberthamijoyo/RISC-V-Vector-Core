...
public:
    ...
    void setupUi(QDialog *NewDialog)
    {
        ...
        page_select_tree->setObjectName("page_select_tree");
        ...
        reset_at_compile->setObjectName("reset_at_compile");
        ...
        elf_file->setObjectName("elf_file");
        ...
        hazard_unit->setObjectName("hazard_unit");
        ...
        hazard_stall->setObjectName("hazard_stall");

        verticalLayout_3->addWidget(hazard_stall);

        hazard_stall_forward = new QRadioButton(hazard_unit);
        hazard_stall_forward->setObjectName("hazard_stall_forward");
        ...
        group_bp_btb->setObjectName("group_bp_btb");
        group_bp_btb->setFlat(false);
        gridLayout = new QGridLayout(group_bp_btb);
        gridLayout->setObjectName("gridLayout");
        line_bp_btb = new QFrame(group_bp_btb);
        line_bp_btb->setObjectName("line_bp_btb");
        line_bp_btb->setFrameShape(QFrame::Shape::HLine);
        line_bp_btb->setFrameShadow(QFrame::Shadow::Sunken);

        gridLayout->addWidget(line_bp_btb, 1, 0, 1, 3);

        text_bp_btb_addr_bits_number = new QLabel(group_bp_btb);
        text_bp_btb_addr_bits_number->setObjectName("text_bp_btb_addr_bits_number");
        ...
        text_bp_btb_addr_bits->setObjectName("text_bp_btb_addr_bits");

        gridLayout->addWidget(text_bp_btb_addr_bits, 0, 0, 1, 1);

        slider_bp_btb_addr_bits = new QSlider(group_bp_btb);
        slider_bp_btb_addr_bits->setObjectName("slider_bp_btb_addr_bits");
        ...
        layout_bp_btb_status->setObjectName("layout_bp_btb_status");
        text_bp_btb_entries = new QLabel(group_bp_btb);
        text_bp_btb_entries->setObjectName("text_bp_btb_entries");
        ...
        text_bp_btb_entries_number->setObjectName("text_bp_btb_entries_number");
        ...
        spacer_bp_btb_status = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        layout_bp_btb_status->addItem(spacer_bp_btb_status);

        line_bp_btb_status = new QFrame(group_bp_btb);
        line_bp_btb_status->setObjectName("line_bp_btb_status");
        line_bp_btb_status->setFrameShape(QFrame::Shape::VLine);
        line_bp_btb_status->setFrameShadow(QFrame::Shadow::Sunken);

        layout_bp_btb_status->addWidget(line_bp_btb_status);

        text_bp_btb_bits = new QLabel(group_bp_btb);
        text_bp_btb_bits->setObjectName("text_bp_btb_bits");
        ...
        text_bp_btb_bits_number->setObjectName("text_bp_btb_bits_number");
        ...
        group_bp_bht->setObjectName("group_bp_bht");
        gridLayout_2 = new QGridLayout(group_bp_bht);
        gridLayout_2->setObjectName("gridLayout_2");
        text_bp_bht_bhr_bits_number = new QLabel(group_bp_bht);
        text_bp_bht_bhr_bits_number->setObjectName("text_bp_bht_bhr_bits_number");
        ...
        text_bp_bht_addr_bits_number->setObjectName("text_bp_bht_addr_bits_number");
        ...
        slider_bp_bht_bhr_bits->setObjectName("slider_bp_bht_bhr_bits");
        ...
        slider_bp_bht_addr_bits->setObjectName("slider_bp_bht_addr_bits");
        ...
        text_bp_bht_bhr_bits->setObjectName("text_bp_bht_bhr_bits");
        ...
        line_bp_bht->setObjectName("line_bp_bht");
        line_bp_bht->setFrameShape(QFrame::Shape::HLine);
        line_bp_bht->setFrameShadow(QFrame::Shadow::Sunken);

        gridLayout_2->addWidget(line_bp_bht, 2, 0, 1, 3);

        text_bp_bht_addr_bits = new QLabel(group_bp_bht);
        text_bp_bht_addr_bits->setObjectName("text_bp_bht_addr_bits");
        ...
        layout_bp_bht_status->setObjectName("layout_bp_bht_status");
        text_bp_bht_entries = new QLabel(group_bp_bht);
        text_bp_bht_entries->setObjectName("text_bp_bht_entries");
        ...
        text_bp_bht_entries_number->setObjectName("text_bp_bht_entries_number");
        ...
        spacer_bp_bht_status = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        layout_bp_bht_status->addItem(spacer_bp_bht_status);

        line_bp_bht_status = new QFrame(group_bp_bht);
        line_bp_bht_status->setObjectName("line_bp_bht_status");
        line_bp_bht_status->setFrameShape(QFrame::Shape::VLine);
        line_bp_bht_status->setFrameShadow(QFrame::Shadow::Sunken);

        layout_bp_bht_status->addWidget(line_bp_bht_status);

        text_bp_bht_bits = new QLabel(group_bp_bht);
        text_bp_bht_bits->setObjectName("text_bp_bht_bits");
        ...
        text_bp_bht_bits_number->setObjectName("text_bp_bht_bits_number");
        ...
        mem_time_write->setObjectName("mem_time_write");
        ...
        mem_time_level2->setObjectName("mem_time_level2");
        ...
        osemu_known_syscall_stop->setObjectName("osemu_known_syscall_stop");
        ...
        osemu_unknown_syscall_stop->setObjectName("osemu_unknown_syscall_stop");
        ...
        osemu_interrupt_stop->setObjectName("osemu_interrupt_stop");
        ...
        osemu_exception_stop->setObjectName("osemu_exception_stop");
        ...
        verticalSpacer_4 = new QSpacerItem(21, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        pushButton_example->setObjectName("pushButton_example");

        horizontalLayout_2->addWidget(pushButton_example);

        pushButton_start_empty = new QPushButton(NewDialog);
        pushButton_start_empty->setObjectName("pushButton_start_empty");
