...
struct qt_meta_stringdata_CLASSMemoryModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMemoryModelENDCLASS = QtMocHelpers::stringData(
    "MemoryModel",
    "cell_size_changed",
    "",
    "setup_done",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMemoryModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MemoryModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMemoryModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMemoryModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMemoryModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MemoryModel, std::true_type>,
        // method 'cell_size_changed'
...
void MemoryModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setup((*reinterpret_cast< std::add_pointer_t<machine::Machine*>>(_a[1]))); break;
        case 3: _t->set_cell_size((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->check_for_updates(); break;
        case 5: _t->cached_access((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MemoryModel::cell_size_changed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MemoryModel::*)();
            if (_t _q_method = &MemoryModel::setup_done; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *MemoryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMemoryModelENDCLASS.stringdata0))
