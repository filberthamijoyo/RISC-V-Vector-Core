...
struct qt_meta_stringdata_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS = QtMocHelpers::stringData(
    "osemu::OsSyscallExceptionHandler",
    "char_written",
    "",
    "fd",
    "val",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject osemu::OsSyscallExceptionHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<machine::ExceptionHandler::staticMetaObject>(),
    qt_meta_stringdata_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OsSyscallExceptionHandler, std::true_type>,
        // method 'char_written'
...
void osemu::OsSyscallExceptionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->char_written((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &OsSyscallExceptionHandler::char_written; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &OsSyscallExceptionHandler::rx_byte_pool; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *osemu::OsSyscallExceptionHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSosemuSCOPEOsSyscallExceptionHandlerENDCLASS.stringdata0))
